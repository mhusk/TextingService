...
function SetUpTriggers(dateInfo, timeInfo){
  ...
  //var postTimePlusHour = new Date(year, month, day, hour+1, minute);
  //Logger.log(postTime);
  ...
  // // Might not need to worry since each trigger is only meant to fire once.
  // var deleteTrigger_ID = ScriptApp.newTrigger('DeletePostTrigger')
  //   .timeBased()
  //   .at(postTimePlusHour)
  //   .create()
  //   .getUniqueId()
  
  // properties.setProperty('scheduledPost_ID',sendPost_TriggerID);
  // properties.setProperty('deleteTrigger_ID', deleteTrigger_ID);
}
